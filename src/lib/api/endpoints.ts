...
export const API_ENDPOINTS = {
  ...
  EXERCISES_CHECK_LATEX: (id: string) => `${API_VERSION}/admin/exercises/${id}/check-latex`,
  EXERCISES_FIX_LATEX: (id: string) => `${API_VERSION}/admin/exercises/${id}/fix-latex`,
  EXERCISES_VALIDATE_JSON: `${API_VERSION}/admin/exercises/validate-json`,
  EXERCISES_CHECK_JSON: `${API_VERSION}/admin/exercises/check-json`,
