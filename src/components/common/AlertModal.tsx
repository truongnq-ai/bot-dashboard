...
interface AlertModalProps {
  ...
  title: string;
  content: React.ReactNode; // Cho phép HTML/React components
  okButtonText?: string;
...
export default function AlertModal({
  ...
  content,
  okButtonText = 'OK',
  showCloseButton = false, // Ẩn close button X, chỉ dùng button OK
}: AlertModalProps) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} showCloseButton={showCloseButton}>
      <div className="p-4 sm:p-6">
        {/* Alert header với title */}
        ...
        {/* Custom content với HTML/React components */}
        <div>
          {content}
        </div>
